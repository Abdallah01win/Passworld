...
<template>
     <main class="flex items-center justify-center h-full">
        <div class="flex flex-col items-center gap-y-8">
            <img src="../assets/404.svg" alt="404" class="mb-6">
            <p class="font-bold text-lg bg-white border-[3px] border-myBlack py-4 text-center w-full rounded-lg">Page Not Found... There's Nothing Here!</p>
