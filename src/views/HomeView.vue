...
<template>
  ...
  <section id="generatorSection">
    <div class="sm:max-w-[520px] md:max-w-[680px] lg:max-w-[940px] xl:max-w-[1024px] mx-auto py-20 grid grid-cols-1 lg:grid-cols-2 gap-x-8 max-lg:gap-y-4">
    <div>
      <div class="sm:text-3xl text-4xl font-bold mb-6 leading-tight">Secure your vertuale life with the strongest passwords.</div>
